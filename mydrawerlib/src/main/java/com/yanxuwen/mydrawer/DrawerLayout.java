            ...
            switch (mdirection) {
                ...
                case ORIENTATION_BOTTOM:
                    ...
                    if (top == 0) {
                        ...
                        if (mOnDrawerStatusListener != null) mOnDrawerStatusListener.onStatus(true);
                    }
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        switch (mdirection) {
            ...
            case ORIENTATION_TOP:
                ...
                mDescView.layout(0, mTop_descView + 0, r, mTop_descView + mDescView.getMeasuredHeight());
                break;
            case ORIENTATION_BOTTOM:
                content.layout(0, mTop + 0, r, mTop + content.getMeasuredHeight());
                mDescView.layout(0, mTop + 0, r, mTop + mDescView.getMeasuredHeight());
                break;
        }
